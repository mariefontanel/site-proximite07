...
<article class="bloc_icones">
	...
	<a href="#bloc_territoires"><img src="images/territoirerbleuplein++.svg" class="icone_territoires"><div class="titre_bloc_icone">Territoire et acteurs</div>
	</a>
</article>

<div class="bloc_presentation">
	<div class="map">
		<img src="images/ardechesiteproximitecanton2.0.svg" class="carte_ardeche">
...
<div class="introduction">
	...
	<p>Il intervient sur les <strong>Communautés de communes du pays de Lamastre</strong>, <strong>Valeyrieux</strong> et sur une <strong>partie de la Communauté d’agglomération centre Ardèche</strong>.
		...
		<p> cofinancé par le <a href="http://www.fse.gouv.fr/" target="_blank">FSE</a></p>
