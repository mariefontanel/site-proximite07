...
<div class="presentation_asso">
	<div class="texte_asso">
		...
		<p>Le Site de proximité des Boutières fait partie du réseau régional des Sites de proximité qui compte aujourd’hui 3 autres structures :</p>
			<ul>
				<li>AmeSud, Site de proximité sud Ardèche www.amesud.fr</li>
				<li>Maison des services des monts du Forez (Loire) www.msmf.fr</li>
				<li>Site de proximité Aix-Urfé Roannais Agglomération-COPLER (Loire) http://www.ccpu.fr/index.php/site-de-proximite</li>
			</ul>
